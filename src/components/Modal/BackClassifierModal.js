...
function BackClassifierModal(props) {
  ...
  async function getList() {
    try {
      const { data = [] } = await axios({
        url: `back/classifiers/dpSetting`,
        method: "GET",
        params: {
          classifierName,
          folder
                  ...
                  return (
                    <div className="row">
                      ...
                      <div className="col-2 text-center">
                        <Switch checked={searchable} onChange={e => onChangeData(fieldName, !searchable, 'searchable')} disabled />
                      </div>
                      <div className="col-2 text-center">
...
export default BackClassifierModal;
